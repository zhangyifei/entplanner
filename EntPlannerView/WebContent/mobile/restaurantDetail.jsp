...
<div data-role="page" id="index">
    ...
    <ul>
        <li><a href="#">Home</a></li>
        <li><a href="#" class="ui-btn-active">Restaurant Detail</a></li>
...
<div data-role="page" id="map-page">
	...
	<h1>Restaurant Street View</h1>
	</div>
	<p><a href="#one" data-rel="back" class="ui-btn ui-shadow ui-corner-all ui-btn-inline ui-icon-back ui-btn-icon-left">Back to Restaurant Page</a></p>
